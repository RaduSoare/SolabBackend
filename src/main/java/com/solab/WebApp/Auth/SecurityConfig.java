    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        */
        http.csrf().disable().authorizeRequests()
                ...
                .mvcMatchers(HttpMethod.DELETE,"/post/{id}").authenticated()
                .mvcMatchers(HttpMethod.POST,"/application").permitAll()
                .mvcMatchers(HttpMethod.GET,"/application/{id}").authenticated()
